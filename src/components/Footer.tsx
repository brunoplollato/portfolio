...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-bg)]" role="contentinfo">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <ul className="flex flex-wrap justify-center gap-x-6 gap-y-2" role="list">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-xs text-[var(--color-muted)] hover:text-[var(--color-text)] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] rounded"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div className="flex items-center gap-4" aria-label="Social links">
            <a
              ...
              aria-label="GitHub"
              className="text-[var(--color-muted)] hover:text-[var(--color-text)] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] rounded"
            >
